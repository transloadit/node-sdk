  ...
  _createClass(TransloaditClient, [{
    ...
    value: function createAssembly(_ref, cb) {
      ...
      var sendRequest = function sendRequest() {
        _this._remoteJson(requestOpts, function (err, result) {
    ...
    value: function deleteAssembly(assemblyId, cb) {
      ...
      this.getAssembly(assemblyId, function (err, _ref2) {
    ...
    value: function replayAssemblyNotification(_ref4, cb) {
      var assemblyId = _ref4.assembly_id,
          notifyUrl = _ref4.notify_url;
    ...
    value: function getAssembly(assemblyId, cb) {
      ...
      operation.attempt(function (attempt) {
        _this5._remoteJson(opts, function (err, result) {
          if (err != null) {
    ...
    value: function _remoteJson(opts, cb) {
      ...
      operation.attempt(function () {
        _this7.__remoteJson(opts, function (err, result) {
          if (err != null) {
