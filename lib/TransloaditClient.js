...
(function() {
  var PaginationStream, TransloaditClient, crypto, fs, reqr, request, retry, unknownErrMsg, _;
  ...
  TransloaditClient = (function() {
    ...
    TransloaditClient.prototype.createAssembly = function(opts, cb) {
      ...
      return this._remoteJson(requestOpts, (function(_this) {
        return function(err, result) {
          ...
          err = new Error((_ref = (_ref1 = result.error) != null ? _ref1 : result.message) != null ? _ref : unknownErrMsg);
          return cb(err);
        };
      })(this));
    };
    ...
    TransloaditClient.prototype._prepareParams = function(params) {
      ...
      if ((_base1 = params.auth).expires == null) {
        _base1.expires = this._getExpiresDate();
      }
