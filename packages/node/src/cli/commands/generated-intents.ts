...
class PreviewGenerateCommand extends GeneratedStandardFileIntentCommand {
  ...
  optimize = Option.Boolean('--optimize', {
    description:
  ...
  optimizeProgressive = Option.Boolean('--optimize-progressive', {
    description:
  ...
  clipLoop = Option.Boolean('--clip-loop', {
    description:
...
class ImageOptimizeCommand extends GeneratedStandardFileIntentCommand {
  ...
  progressive = Option.Boolean('--progressive', {
    description:
  ...
  preserveMetaData = Option.Boolean('--preserve-meta-data', {
    description:
  ...
  fixBreakingImages = Option.Boolean('--fix-breaking-images', {
    description:
...
class ImageResizeCommand extends GeneratedStandardFileIntentCommand {
  ...
  flatten = Option.Boolean('--flatten', {
    description:
  ...
  adaptiveFiltering = Option.Boolean('--adaptive-filtering', {
    description:
  ...
  watermarkRepeatY = Option.Boolean('--watermark-repeat-y', {
    description:
  ...
  trimWhitespace = Option.Boolean('--trim-whitespace', {
    description:
  ...
  monochrome = Option.Boolean('--monochrome', {
    description:
...
class DocumentConvertCommand extends GeneratedStandardFileIntentCommand {
  ...
  pdfPrintBackground = Option.Boolean('--pdf-print-background', {
    description:
  ...
  pdfDisplayHeaderFooter = Option.Boolean('--pdf-display-header-footer', {
    description:
...
class DocumentOptimizeCommand extends GeneratedStandardFileIntentCommand {
  ...
  removeMetadata = Option.Boolean('--remove-metadata', {
    description:
  ...
  linearize = Option.Boolean('--linearize', {
    description:
...
class DocumentThumbsCommand extends GeneratedStandardFileIntentCommand {
  ...
  antialiasing = Option.Boolean('--antialiasing', {
    description:
  ...
  pdfUseCropbox = Option.Boolean('--pdf-use-cropbox', {
    description:
...
class AudioWaveformCommand extends GeneratedStandardFileIntentCommand {
  ...
  splitChannels = Option.Boolean('--split-channels', {
    description:
  ...
  noAxisLabels = Option.Boolean('--no-axis-labels', {
    description:
      'Available when style is `"v1"`. If set to `true`, renders waveform image without axis labels.',
  })

  withAxisLabels = Option.Boolean('--with-axis-labels', {
    description:
